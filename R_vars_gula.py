...
###################################################################################
    ...
    def get_sig(self,ncfile,simul,debug=False,**kwargs):
        ...
        ################################################
            ...
            #this is the python version
            var = tools.get_div(u,v,z_r,z_w,pm,pn)  
...
#######################################################
    ...
    def interpolate_bulk_winds(self, simul, time=None, **kwargs):
        ...
        u_blk1 = toolsF_gi.cinterp2d(lon_cfsr, lat_cfsr, uwnd1.T,\
                                 Istr, Iend, Jstr, Jend,\
                                 x,y)
        print('interp uwnd1 OK')
        
        v_blk1 = toolsF_gi.cinterp2d(lon_cfsr,lat_cfsr, vwnd1.T,\
                                 Istr, Iend, Jstr, Jend,\
                                 x,y)
        print('interp vwnd1 OK')
        
        u_blk2 = toolsF_gi.cinterp2d(lon_cfsr,lat_cfsr, uwnd2.T,\
                                 Istr, Iend, Jstr, Jend,\
                                 x,y)
        print('interp uwnd2 OK')
        
        v_blk2 = toolsF_gi.cinterp2d(lon_cfsr,lat_cfsr, vwnd2.T,\
                                 Istr, Iend, Jstr, Jend,\
                                 x,y)
    ...
    def interpolate_bulk_vars(self, simul, time=None, **kwargs):
        ...
        tair = toolsF_gi.cinterp2d(lon_cfsr,lat_cfsr, tair.T,
                                 Istr, Iend, Jstr, Jend,
                                 x,y)
        ...
        rhum = toolsF_gi.cinterp2d(lon_cfsr,lat_cfsr, rhum.T,
                                 Istr, Iend, Jstr, Jend,
                                 x,y)
