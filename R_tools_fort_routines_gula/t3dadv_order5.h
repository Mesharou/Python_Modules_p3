          ...
          DO j = Jstr,Jend+1  !j_loop_y_flux_5
            ...
            IF ( j.ge.jmin .and. j.le.jmax ) THEN ! use full stencil
              ...
              DO i = Istr,Iend
                vel = Hvom(i,j,k)
                flx5 = vel*FLUX5(
     &             t(i,j-3,k,itrc), t(i,j-2,k,itrc),
     &             t(i,j-1,k,itrc), t(i,j  ,k,itrc),
     &             t(i,j+1,k,itrc), t(i,j+2,k,itrc),  vel )
#ifdef MASKING
                flx3 = vel*FLUX3(
     &             t(i,j-2,k,itrc), t(i,j-1,k,itrc),
     &             t(i,j  ,k,itrc), t(i,j+1,k,itrc),  vel )
                flx2 = vel*FLUX2(
     &             t(i,j-1,k,itrc), t(i,j,k,itrc), vel, cdif)
# ifdef UP5_MASKING
          ...
          DO i = Istr,Iend+1  !i_loop_x_flux_5
            ...
            IF ( i.ge.imin .and. i.le.imax ) THEN ! use full stencil
              ...
              DO j = Jstr,Jend
                vel = Huon(i,j,k)
                flx5 = vel*FLUX5(
     &             t(i-3,j,k,itrc), t(i-2,j,k,itrc),
     &             t(i-1,j,k,itrc), t(i  ,j,k,itrc),
     &             t(i+1,j,k,itrc), t(i+2,j,k,itrc),  vel )
#ifdef MASKING
                flx3 = vel*FLUX3(
     &             t(i-2,j,k,itrc), t(i-1,j,k,itrc),
     &             t(i  ,j,k,itrc), t(i+1,j,k,itrc),  vel )
                flx2 = vel*FLUX2(
     &             t(i-1,j,k,itrc), t(i,j,k,itrc), vel, cdif)
# ifdef UP5_MASKING
